...
function createUser(producator, price, image, description) {
  const userContainer = document.createElement("article");
  const imgEl = document.createElement("img");
  const nameEl = document.createElement("div");
  const emailEl = document.createElement("div");
  const detailsEl = document.createElement("div");
  nameEl.textContent = producator;
  emailEl.textContent = price;
  imgEl.src = image;
...
const { producator,description, price , image } = product;
