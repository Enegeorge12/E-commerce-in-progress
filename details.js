...
const product = produse.find((product) => product.id == productId);
// console.log(product)

function createUser(producator, price, image, description,variety,name,country ,year) {
 ...
 section.classList.add("product-details");
 


  const productNameProducator = document.createElement("h1");
  ...
  const detailsWine=document.createElement('div');
  ...
  const productTypeWine=document.createElement("div");
  

  
  productTypeWine.textContent ="Vin: " + wine;
  productYear.textContent ="An: "+ year;
  productBtnCart.textContent="Adauga in cos";
  productName.textContent="Producator: " +producator;
  productCountry.textContent="Tara : "+ country;
  detailsWine.textContent="Soi : "+ variety;
  productNameProducator.textContent = name;
  productPrice.textContent ="Pret : " +  price+ " Lei";
  productImg.src = image;
  productDescription.textContent ="Descriere : " + description;
  
 
  productContainer.appendChild(productImg);
  section.appendChild(productNameProducator);
  section.appendChild(productName);
  section.appendChild(productPrice);
  section.appendChild(productYear);
  section.appendChild(productTypeWine);
  section.appendChild(productCountry);
  section.appendChild(detailsWine);
  section.appendChild(productDescription);
  section.appendChild(productBtnCart);
  productContainer.appendChild(section);
  return productContainer;
}

const {producator, price, image, description,variety ,name, country,year,wine,id} = product;
